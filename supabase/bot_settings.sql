...
values (
  ...
  jsonb_build_object(
    ...
    'commands', jsonb_build_array(
      ...
      jsonb_build_object('command', '!aktifkan jadwal [tautan grup]', 'description', 'Khusus DM admin: mengaktifkan kirim jadwal otomatis pukul 17.00 dan 20.00 WIB tanpa menulis perintah di grup.'),
      jsonb_build_object('command', '!nonaktifkan jadwal', 'description', 'Khusus DM admin: menghentikan pengiriman jadwal otomatis.'),
